...
if not web_based:
    ...
    screen.title("Happy Christmas from Abinash Nath Pandey")
...
text_1.write("Abinash Nath", font=("Avenir", max(int(30 / i_scale), 15), "normal"),
             align="center")
...
text_1.write("Pandey", font=("Avenir", max(int(30 / i_scale), 15), "normal"),
             align="center")
